...
public struct SpirVVersion : IEquatable<SpirVVersion>
{
	...
	public bool Equals(SpirVVersion other) => version == other.version;
	...
	public SpirVVersion(uint major, uint minor) => version = (major << 16) + (minor << 8);
...
{
	private readonly IntPtr sourceName;
...
// object.
internal delegate IntPtr PFN_IncludeResolve(IntPtr userData, string requestedSource, int type, string requestingSource,
	UIntPtr includeDepth);
...
{
	private const string lib = "Native/Libs/shaderc_shared.dll";
	...
	[DllImport(lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
	internal static extern void shaderc_compile_options_set_include_callbacks(IntPtr options, IntPtr resolver,
		IntPtr result_releaser, IntPtr user_data);
	...
	[DllImport(lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
	internal static extern void shaderc_compile_options_set_forced_version_profile(IntPtr options, int version,
		Profile profile);
	...
	[DllImport(lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
	internal static extern void shaderc_compile_options_set_target_env(IntPtr options, TargetEnvironment target,
	...
	[DllImport(lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
	internal static extern void shaderc_compile_options_set_binding_base(IntPtr options, UniformKind kind, uint _base);
	...
	[DllImport(lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
	internal static extern void shaderc_compile_options_set_binding_base_for_stage(IntPtr options,
		ShaderKind shader_kind, UniformKind kind, uint _base);
	...
	[DllImport(lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
	internal static extern void shaderc_compile_options_set_hlsl_register_set_and_binding_for_stage(IntPtr options,
		ShaderKind shader_kind, string reg, string set, string binding);

	// Like shaderc_compile_options_set_hlsl_register_set_and_binding_for_stage,
	// but affects all shader stages.
	[DllImport(lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
	internal static extern void shaderc_compile_options_set_hlsl_register_set_and_binding(IntPtr options, string reg,
		string set, string binding);
