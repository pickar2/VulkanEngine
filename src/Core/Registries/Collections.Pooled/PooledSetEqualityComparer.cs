...
/*internal sealed class PooledSetEqualityComparer<T> : IEqualityComparer<PooledSet<T>>
{
	...
	public PooledSetEqualityComparer() => _comparer = EqualityComparer<T>.Default;

	// using m_comparer to keep equals properties intact; don't want to choose one of the comparers
	public bool Equals(PooledSet<T> x, PooledSet<T> y) => PooledSet<T>.PooledSetEquals(x, y, _comparer);
	...
	public override bool Equals(object obj)
	{
		...
		if (obj is IEqualityComparer<T> ieq)
		{
