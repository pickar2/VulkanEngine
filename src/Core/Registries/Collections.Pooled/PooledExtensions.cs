...
public static class PooledExtensions
{
	...
	public static PooledDictionary<TKey, TValue> ToPooledDictionary<TSource, TKey, TValue>(this Span<TSource> source,
		Func<TSource, TKey> keySelector, Func<TSource, TValue> valueSelector, IEqualityComparer<TKey> comparer) =>
		ToPooledDictionary((ReadOnlySpan<TSource>) source, keySelector, valueSelector, comparer);
	...
	public static PooledDictionary<TKey, TValue> ToPooledDictionary<TSource, TKey, TValue>(this ReadOnlyMemory<TSource> source,
		Func<TSource, TKey> keySelector, Func<TSource, TValue> valueSelector, IEqualityComparer<TKey> comparer) =>
		ToPooledDictionary(source.Span, keySelector, valueSelector, comparer);
	...
	public static PooledDictionary<TKey, TSource> ToPooledDictionary<TSource, TKey>(this Span<TSource> source,
		Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer) =>
		ToPooledDictionary((ReadOnlySpan<TSource>) source, keySelector, comparer);
	...
	public static PooledDictionary<TKey, TSource> ToPooledDictionary<TSource, TKey>(this ReadOnlyMemory<TSource> source,
		Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer) =>
		ToPooledDictionary(source.Span, keySelector, comparer);
	...
	public static PooledSet<T> ToPooledSet<T>(this IEnumerable<T> source, IEqualityComparer<T> comparer = null) => new(source, comparer);

	public static PooledSet<T> ToPooledSet<T>(this Span<T> source, IEqualityComparer<T> comparer = null) => new(source, comparer);

	public static PooledSet<T> ToPooledSet<T>(this ReadOnlySpan<T> source, IEqualityComparer<T> comparer = null) => new(source, comparer);

	public static PooledSet<T> ToPooledSet<T>(this Memory<T> source, IEqualityComparer<T> comparer = null) => new(source.Span, comparer);

	public static PooledSet<T> ToPooledSet<T>(this ReadOnlyMemory<T> source, IEqualityComparer<T> comparer = null) => new(source.Span, comparer);
